...
//          注册 model_router/quality 工具: lambda 解析 args → QualityModelRouterPolicy::route()。
...
// Plugin 入口: 注册 model_router/quality 工具
extern "C" void pdk_register_tools(::agenticdsl::IToolRegistry& registry) {
  ...
  ::agenticdsl::ToolMetadata meta{
    "model_router/quality",                      // name
    "质量优先模型路由: 按 tag 匹配度/上下文容量排序返回最优模型",  // description
    "model_router",                              // domain
