...
- ✅ ADR-0068 V2 EventBuilder — ship 2026-08-03 (`openspec/changes/archive/2026-08-03-promote-event-builder-fulltoolresult-support/`)，`context.compact.before/after` 事件发射契约就绪
- ✅ SessionConfig.compact_threshold_tokens 已声明（Sprint 0）
- 🟡 ADR-0007 快照机制 ship 但 LLM 摘要压缩未实施 — 本提案落地后转 ✅ Approved
