...
- [ ] 1.1 评估: ToolCoordinator 是否需要异步路径 (依 C2 ADR-0030 V2 决策)
- [ ] 1.2 业务确认: Layer × Tool Category 权限矩阵的默认值
...
- [ ] 2.4 写 specs/toolcoordinator/spec.md (5-8 ADDED Requirements)
- [ ] 2.5 移除所有 "PLACEHOLDER" 标记, 更新 STATUS 行

## 3. P3 实施 (Sprint 14 Day 1-5) — ToolCoordinator 中间件

- [ ] 3.1 TBD: ToolCoordinator 类实现
- [ ] 3.2 TBD: 集成 IExecutionPolicy
- [ ] 3.3 TBD: 集成 ApprovalCoordinator
- [ ] 3.4 TBD: 审计日志到 EventBus

## 4. NodeExecutor 集成 (Sprint 14 Day 6-7)

- [ ] 4.1 TBD: 替换直接 call_tool
- [ ] 4.2 TBD: 异常传播路径保持

## 5. P4 实施 (Sprint 14 Day 8-10) — Layer Profile

- [ ] 5.1 TBD: Layer enum
- [ ] 5.2 TBD: LayerProfile 类
- [ ] 5.3 TBD: ToolMetadata V2 扩展
- [ ] 5.4 TBD: 权限矩阵

## 6. 测试 (Sprint 14 Day 11-13)

- [ ] 6.1 TBD: ToolCoordinator 单元测试
- [ ] 6.2 TBD: LayerProfile 单元测试
- [ ] 6.3 TBD: 集成测试

## 7. 验证 (Sprint 14 Day 14)

- [ ] 7.1 `ctest --output-on-failure` ≥ 47/47 + 新增 N 个 PASS
...
- [ ] 7.6 `openspec validate 2026-06-26-adr-0031-p3p4-toolcoordinator` exit 0
- [ ] 7.7 `git status` clean

## 8. 同步与归档 (Sprint 14 Day 15)

- [ ] 8.1 更新 `docs/adr/adr-0031-execution-policy.md`: P1-P2 ✅ Approved → ✅ Approved (全部 P1-P4)
...
- [ ] 8.6 `openspec archive 2026-06-26-adr-0031-p3p4-toolcoordinator --yes`
- [ ] 8.7 同步 master plan C4 行: 状态更新
- [ ] 8.8 触发 C6 (ADR-0004 V2) 启动准备

---

## 验证检查清单 (C4 ship gate)

- [ ] 1. ADR-0031 P3-P4 完整 design
- [ ] 2. ToolCoordinator 完整工作
- [ ] 3. LayerProfile 完整工作
- [ ] 4. NodeExecutor 集成零回归
- [ ] 5. ctest 全绿 (含新增 tests)
- [ ] 6. ASan/TSan 100% clean
- [ ] 7. `openspec validate` exit 0
- [ ] 8. ADR-0031 status ✅ Approved (全部)
- [ ] 9. master plan C4 状态更新
