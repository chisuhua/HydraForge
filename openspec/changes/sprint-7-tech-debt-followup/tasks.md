...
- [ ] 1.1.5 提交: `git commit -m "fix(scheduler): remove duplicated fork handling in dispatch_next_node (Sprint 7 Blocker)"`
...
- [ ] 2.1.11 提交: `git commit -m "test(scheduler): add 7 state-based test cases for split execute() pipeline (Sprint 7)"`
...
- [ ] 3.1.9 提交: `git commit -m "test(parser): add 5 test cases for NodeFactoryRegistry incl. TSan (Sprint 7)"`
...
- [ ] 3.2.5 提交: `git commit -m "docs(openspec): fix spec typos (13→11 NodeType, throw→nullptr) (Sprint 7)"`
...
- [ ] 4.6.1 提交 1: `git commit -m "refactor(scheduler): introduce DagState + pure-function subfunctions + execute ≤ 60 lines (Sprint 7)"`
- [ ] 4.6.2 提交 2: `git commit -m "fix(scheduler): use get_pending_dynamic_deps() accessor consistently (Sprint 7)"`
...
- [ ] 5.1.6 提交: `git commit -m "refactor(scheduler): add Config param to factory + integrate engine.cpp call (Sprint 7)"`
...
- [ ] 6.5.1 提交 1: `git commit -m "refactor(tools): add create_registry factory + integrate engine.cpp (Sprint 7)"`
- [ ] 6.5.2 提交 2: `git commit -m "refactor(budget): introduce IBudgetController abstraction + factory returns interface (Sprint 7)"`
- [ ] 6.5.3 提交 3: `git commit -m "refactor(llm): add create_mock_provider factory + engine.cpp include ≤ 3 (Sprint 7)"`
...
- [ ] 7.1.7 提交: `git commit -m "test(engine_factory): add 3 test cases for 3 factory functions (Sprint 7)"`
...
- [ ] 8.4.1 提交 1: `git commit -m "test(plugin): rename 7 test cases to match spec + implement mock .so fixture (Sprint 7)"`
...
- [ ] 9.1.6 `openspec validate tech-debt-cleanup-sprint-6` exit 0 (含 spec 修正后)
...
- [ ] 9.2.1 编辑 `docs/adr/adr-0019-*.md` §1.4 状态: engine.cpp include ≤ 3 达成 (本次 Sprint 7)
- [ ] 9.2.2 编辑 `docs/adr/adr-0020-thread-model-isolation.md` (无需改, Sprint 3 已 Resolved)
- [ ] 9.2.3 编辑 `docs/README.md` ADR-0019 状态行同步
- [ ] 9.2.4 编辑 `AGENTS.md` § Recent Changes 追加 Sprint 7 总结 + Sprint 6 final 标记
- [ ] 9.2.5 更新 `tech-debt-cleanup-sprint-6/tasks.md` §5 全部 `[x]` + §6.3 全部 `[x]`
- [ ] 9.2.6 更新 `tech-debt-cleanup-sprint-6/tasks.md` §4 全部 `[x]`
- [ ] 9.2.7 提交: `git commit -m "docs(adr+status): Sprint 7 ship + ADR-0019 §1.4 final Resolved (engine.cpp ≤3)"`
...
- [ ] 10.2.3 编辑 `openspec/changes/sprint-7-tech-debt-followup/tasks.md` §10.2.1 标 `[x]`
...
- [ ] 10.4.1 提交: `git commit -m "chore(openspec): archive tech-debt-cleanup-sprint-6 + Sprint 7 final (Sprint 7 ship)"`
- [ ] 10.4.2 `git tag sprint-7-tech-debt-followup-ship` + `git push --tags`
- [ ] 10.4.3 更新 `AGENTS.md` 顶部状态: Sprint 7 ship 标记

---

## 11. 验证检查清单 (Sprint 7 ship gate)

- [ ] 11.1 Sprint 6 + Sprint 7 全部 task 100% 完成
...
- [ ] 11.7 `openspec validate sprint-7-tech-debt-followup` exit 0
...
- [ ] 11.12 AGENTS.md § Recent Changes 含 Sprint 6 final + Sprint 7 ship 标记
- [ ] 11.13 PDK 同步脚本无 error (`./scripts/sync-pdk.sh --dry-run`)
- [ ] 11.14 `git log --oneline -1` 显示 Sprint 7 final commit
