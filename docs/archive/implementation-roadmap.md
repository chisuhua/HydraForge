...
**来源**: `docs/proposals/implementation/phase-0-implementation.md` + `docs/proposals/implementation/self-bootstrapping-path.md`
...
### ADR-0032 — CostCollector (✅ Approved, 2026-06-30 状态提升；C9 docs audit 二次确认)

> **状态 (2026-07-06 同步)**: ✅ Approved — 2026-06-30 状态提升 (原 archive/adr/adr-0032 已标 ✅), 2026-07-03 经 C9 `phase4-5-impl-scope-audit` docs audit 二次确认. 4 核心类 (`CostTracker` + `CostRecord` + `CostStats` + 全局累加) 已 ship (commit `451e395`, 2026-06-14); `BudgetController::CostTracker` 集成延后至 C6 (ADR-0004 V2 + IBudgetController) 已 ship. 注: ADR-0032 实施 ship 时间 (2026-06-14) 早于 C9 ship 时间 (2026-07-03), C9 为 docs-only audit 不涉及代码改动。
> **状态变更**: ❌ Not Implemented (2026-06-12 归档) → 🟡 Partial (2026-06-26, `doc-alignment-adr-states`) → ✅ Approved (2026-06-30 状态提升, 2026-07-03 C9 docs audit 二次确认).
...
**来源**: `docs/proposals/implementation/self-bootstrapping-path.md`
...
| `docs/proposals/implementation/phase-0-implementation.md` | 云端 LLM 集成 (4 Steps) | Phase 0 Track 0.1 |
| `docs/proposals/implementation/self-bootstrapping-path.md` | 阶段 0: 云端集成 + 质量保障 | Phase 0 Track 0.1 |
...
| `docs/proposals/implementation-roadmap/01-roadmap.md` | Phase 5 任务变更 | 2026-05-22 |
| `docs/proposals/implementation/self-bootstrapping-path.md` | Phase 5 阶段调整 | 2026-05-22 |
| `docs/proposals/implementation/phase-0-implementation.md` | Track 0.1 任务变更 | 2026-05-23 |
