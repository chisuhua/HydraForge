> ⚠️ **归档文档（2026-06-12）**
>
> 本文档已在 project-organization 计划 Stage 2 / Task 8 中归档。其覆盖的 13 个 ADR（ADR-0010 ~ ADR-0018，ADR-0030、0032、0034、0036）已在 Stage 2 / Task 7 中归档至 [`docs/archive/adr/`](../adr/README.md)。当前活跃标准库规范为 [`docs/specs/stdlib-v3.10.md`](../../specs/stdlib-v3.10.md)。本文档作为历史 Phase 2 规划保留，仅供参考。
>
> **关联 ADR 归档路径**:
> - 记忆系统 (ADR-0010)、知识图谱 (ADR-0011)、向量语义 (ADR-0012)、用户画像 (ADR-0013)、对话上下文 (ADR-0014)、IPER 闭环 (ADR-0015)、异常快照 (ADR-0016)、反事实推理 (ADR-0017)、图引导假设 (ADR-0018) → `docs/archive/adr/`
> - 成本收集 (ADR-0030)、策略执行 (ADR-0032)、路由器 (ADR-0034)、混合内核 (ADR-0036) → `docs/archive/adr/`
