...
| 维度 | 状态 |
|------|------|
| **Total ctest** | **209/209** 配置总数 (2026-09-01 `ctest -N` → Total Tests: 209; 自 2026-08-31 T1-T7 全 ship 后 +5: T3 evolution-budget-cap 6 cases + T2 mcts-axis6 6 cases + T4 signature-validation 7 cases + T5 cognitive-tools 4 cases + T1 workflow-materializer 5 cases; 208/209 PASS 99%, 1 pre-existing timing flake per AGENTS.md; LastTest.log 为空壳) — ✅ Sprint 24 认知/领域演化系列 T1-T7 全部 ship 完成, ctest baseline 192 → 209 (+17) |
...
- **Wave 4 `control-plane-eval`** — 启动: 6 项条件全 PASS (①AgentForge ≥2 agent ②Solo Dev ≥2 人/≥80h双周 ③ADR-0068 附录 A 主题 ✅ 2026-08-13 archived ④ADR-0073 完整 ship ⑤Evidence Gate PASS ⑥ADR-0075 EnvBackend ship 2026-08-18)。当前 4/6 FAIL（①②⑤⑥），预期估时: 0.5 sprint (纯脚本+决议文档)。
