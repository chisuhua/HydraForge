...
| 维度 | 状态 |
|------|------|
| **Total ctest** | **204** 配置总数 (2026-08-31 `tools/doc_metrics.py ctest -N` → Total Tests: 204; 自 2026-08-28 T20 ship 后 +12: T17 SkillCompiler 6 cases + T15 TrajectoryIR 9 cases + T21 Prompt Evidence Gate + T19 GEPA Phase 2 commit + T20 AFlow MCTS 17 cases + ADR-0068 v1.2 修正事件 + ADR-0061-13 distillation 等; 实际 PASS 数需 ctest 实测, LastTest.log 为空壳建议复跑) — ⚠ 较 2026-08-28 的 192/192 配置基线,新+12 cases 需 W2 末实测验证全 PASS |
...
| **ADR Approved** | **57** (主 49: Phase 0-5 16 + Phase 6 18 [0050/0051/0052-0065/0067] + **ADR-0068** Wave 1 收官 + **ADR-0073** ✅ Approved 2026-08-18 (Phase 6c C9 D2+D3+D4 全 ship) + **ADR-0074** ✅ Approved 2026-08-18 (Phase 6c C1+C2+C3, D1/D2/D3 ship, baseline 数据 handoff to evidence-gate) + **ADR-0075** ✅ Approved 2026-08-18 (Phase 6c C11-C13 D1+D2+D3+D5 全 ship) + **ADR-0081** ✅ Approved 2026-08-22 (Batch 2 P3) + **ADR-0082** ✅ Approved 2026-08-22 (Batch 2 P7) + **ADR-0061-08 v1.1 amendment** ✅ Approved 2026-08-31; plugin 1; skill 子项 7 含 0061-08-v1-1) |
