...
| `genome.committed` | HarnessRSI (evolution) / GEPALoop (cognitive) | Gate 3 persist-before-apply fork 成功 (per genome-wiring-harness-rsi-gepa) | `genome_name`, `version`, `parent`, `mutation_kind` | ✅ (genome-wiring-harness-rsi-gepa, 2026-09-22, Appendix A v2.3 注册) |
