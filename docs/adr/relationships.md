...
| `adr-0030-async-runtime-dual-layer.md` | AsyncRuntime 双层异步架构 | ✅ 已批准 |
| `adr-0031-execution-policy.md` | IExecutionPolicy 执行策略 | 🔍 提议中 |
| `adr-0032-cost-collector.md` | CostCollector 成本收集 | 🔍 提议中 |
| `adr-0033-session-hierarchy.md` | Session 层级模型 | 🔍 提议中 |
| `adr-0034-model-router.md` | IModelRouter 模型路由 | 🔍 提议中 |
| `adr-0036-hybrid-kernel-architecture.md` | 混合内核三层架构 | 🔍 提议中 |
