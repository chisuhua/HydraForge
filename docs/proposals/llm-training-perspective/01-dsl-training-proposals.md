...
> - 自举愿景: [`docs/proposals/vision/01-self-bootstrapping-vision.md`](../vision/01-self-bootstrapping-vision.md)
> - 实施路径: [`docs/proposals/implementation/self-bootstrapping-path.md`](../implementation/self-bootstrapping-path.md)
>
...
- 人类可读性、API 设计 → 见 `docs/proposals/vision/` 与 `docs/proposals/skill-system/`
...
1. 在 `docs/proposals/language-extensions/` 创建 RFC 文档
2. 关联 Oracle 评估
...
1. 在 `docs/proposals/language-extensions/` 创建 RFC 文档（参考 `01-type-system.md` 格式）
2. 关联 Oracle 评估（`docs/proposals/session-state/03-oracle-qa.md` 模式）
3. 进入 ADR 流程（编号 adr-0037+）
4. 在 `docs/specs/dsl.md` 更新规范
