...
| [docs/specs/dsl-lib.md](../../specs/dsl-lib.md) | 当前标准库规范 — 本文的扩展基线 |
| [docs/specs/stdlib.md](../../specs/stdlib.md) | 内置工具和子图规范 — 推理标准库是新的内置领域 |
| [docs/specs/phase2-standard-library.md](../../specs/phase2-standard-library.md) | Phase 2 标准库规划（memory/context 相关），与本文互补 |
