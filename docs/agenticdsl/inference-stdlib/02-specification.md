...
| [docs/specs/dsl-lib.md](../../specs/dsl-lib.md) | 当前标准库目录结构（reasoning/workflow/tools/cognitive），推理标准库遵循其路径约定 |
| [docs/adr/adr-0009-dsl-standard-library.md](../../adr/adr-0009-dsl-standard-library.md) | 标准库规划，推理标准库是规划的扩展方向 |
| [docs/specs/phase2-standard-library.md](../../specs/phase2-standard-library.md) | Phase 2 标准库规划，与本文推理标准库互补 |
