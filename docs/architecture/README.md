...
| `self-evolution-architecture-2026-08.md` | 自进化与协同进化架构定义（证据输入：闭环、支撑平面、阶段边界与当前禁止行为；v1.3 增量同步 §1.3 信用分配契约 + §五 ADR-0086 行 + §七 #6 Approved 翻牌） | 🔍 Proposed (v1.3) | 2026-09-20 | ADR-0084 / T15 / T19 / T20 / T22 状态变化，或协同进化 spike promotion / ADR-0086 v1.0+v1.1 ✅ ship (G16 Closed, C3 unblocked) |
